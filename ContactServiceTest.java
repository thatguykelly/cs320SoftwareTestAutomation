...
public class ContactServiceTest {
	...
	// manual build for each test to follow
@BeforeEach
void setUp() {
...
//test new contact, first name, last name, phone number, address and are not null
@Test
void newContactTest() {
...
//tests that contact has been deleted
@Test
...
// tests that first name has been updated, check for characters and not null
@Test
...
//tests that last name has been updated, check for characters and not null
@Test
...
//tests that phone number has been updated, check for characters and not null
@Test
...
//tests that address has been updated, check for characters and not null
@Test
